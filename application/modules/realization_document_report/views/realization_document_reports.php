...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('realization_document_report')?></p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('realization_document_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                ...
                <div class="form-group form-md-line-input row">
                    <label class="col-md-3 control-label">Pool <span class="text-danger">*</span></label>
                    <div class="col-md-3">
                        <select class="form-control all_select2" name="dep_id" id="dep_id" >
                            <option value="all">- All -</option>
                            <?php
                            foreach($departements as $dep_row){
                                echo '<option value="'.$dep_row->rowID.'">'.$dep_row->dep_name.'</option>';
                            }
                            ?>
                        </select>
                    </div>
