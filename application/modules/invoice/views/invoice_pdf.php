...
<table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
	<tr>
		<th width="4%" style="border:#000 solid 1px;"><div style="margin:5px;">No</div></th>
        <?php
        if($get_data->invoice_type == 'A'){
            echo '<th width="12%" style="border:#000 solid 1px;">AP No</th>';        
            echo '<th width="12%" style="border:#000 solid 1px;">DO No</th>';   
            echo '<th width="9%" style="border:#000 solid 1px;">Police No</th>';
        }
        else{
            echo '<th style="border:#000 solid 1px;">DO No</th>';
            echo '<th width="12%" style="border:#000 solid 1px;">Police No</th>';
        }
        ?>
		<th width="9%" style="border:#000 solid 1px;">DO Date</th>
    ...
    <?php
        ...
        ?>
        		<tr>		
        			...
        			<?php
                    if($get_data->invoice_type == 'A'){
                        $do_no_val = $row->do_no == '' ? '-' : strtoupper($row->do_no);
                        echo '<td align="left" style="border-right:#000 solid 1px;'.$border_bottom.'">'.strtoupper($row->trx_no).'</td>';
                        echo '<td align="left" style="border-right:#000 solid 1px;'.$border_bottom.'">'.$do_no_val.'</td>';
                    }
                    else{
                        $do_no_val = $row->do_no == '' ? '-' : strtoupper($row->do_no);
                        echo '<td align="left" style="border-right:#000 solid 1px;'.$border_bottom.'">'.$do_no_val.'</td>';
        ...
        <?php 
                if($i <= 20){
                    if($i % 20 == 0){
                        if($i != $jumlah_data){
                            ...
                            echo '      <th width="9%" style="border:#000 solid 1px;">DO Date</th>
                                        <th width="10%" style="border:#000 solid 1px;">Cont. Size</th>
                                        <th width="12%" style="border:#000 solid 1px;">Container No</th> 
                                        <th width="8%" style="border:#000 solid 1px;">Qty (Pcs/Kgs)</th>
                                        <th width="8%" style="border:#000 solid 1px;">Unit Price</th>
            ...
            echo '<tr><td align="center" colspan="'.$colspan_all.'" style="border-left:#000 solid 1px;border-right:#000 solid 1px;">Data delivery order not available</td></tr>';
        }
