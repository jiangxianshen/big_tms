...
<section class="vbox">
    <header class="header bg-white b-b b-light">
        ...
        <p class="pull-left"><?=lang('ritase_report')?></p>
    </header>
        ...
        <div class="col-lg-12">
          <div class="panel panel-primary">
            <div class="panel-body">
                <?=form_open(base_url('ritase_report/print_report'),'autocomplete="off" id="form" name="form" class="form-horizontal" target="_blank"')?>
                ...
                <div class="form-group form-md-line-input row">
                    <label class="col-md-3 control-label"><?= lang('police_no') ?> <span class="text-danger">*</span></label>
                    <div class="col-md-3">
                        <select class="form-control all_select2" name="vehicle_rowID" id="vehicle_rowID" >
